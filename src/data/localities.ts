...
// original and Bangalore-specific, written for KMR Real Estates Rentals and Property
...
export const LOCALITIES: Locality[] = [
  {
    ...
    metaTitle:
      'Property for Rent & Sale in Whitefield, Bangalore | 2, 3 & 4 BHK Gated Flats — KMR Real Estates',
    metaDescription:
      'Find premium 2, 3 & 4 BHK flats for rent and houses for sale in Whitefield gated communities. KMR Real Estates — your local real estate agent in East Bangalore.',
    intro:
      'Whitefield is East Bangalore’s flagship IT address, anchored by ITPL, EPIP Zone and the extended tech parks along Whitefield Main Road. Its premium gated communities draw professionals who want walk-to-work convenience alongside international schools, malls and hospitals. KMR Real Estates helps tenants and buyers navigate Whitefield’s fast-moving market for 2, 3 and 4 BHK homes.',
  ...
  },
  {
    ...
    zone: 'East Bangalore (IT Corridor)',
    metaTitle:
      'Property for Rent & Sale on Sarjapur Road, Bangalore | 2, 3 & 4 BHK Gated Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and homes for sale on Sarjapur Road, Bangalore. KMR Real Estates guides renters and buyers across its gated communities.',
    intro:
      'Sarjapur Road connects the Outer Ring Road tech belt to Wipro Corporate Office and the emerging IT clusters toward Attibele. Its newer gated communities offer larger floor plans and greener surroundings than the older core, making it a favourite for families upgrading from 2 BHK to 3 and 4 BHK homes. KMR Real Estates tracks Sarjapur Road’s rapidly expanding real estate inventory.',
  ...
  },
  {
    ...
    zone: 'East Bangalore (IT Corridor)',
    metaTitle:
      'Property for Rent & Sale in Marathahalli, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Looking for a real estate agent in Marathahalli? KMR Real Estates lists premium 2, 3 & 4 BHK flats for rent and sale near the Outer Ring Road IT corridor.',
    intro:
      'Marathahalli sits at the crossroads of the Outer Ring Road and Old Airport Road, putting it within minutes of the Bellandur–Sarjapur tech belt and Whitefield alike. Its mix of established gated communities and value-priced apartments makes it one of East Bangalore’s most rented micro-markets. KMR Real Estates helps tenants find well-connected 2 and 3 BHK homes here.',
  ...
  },
  {
    ...
    metaTitle:
      'Property for Rent & Sale in Electronic City, Bangalore | 2, 3 & 4 BHK Gated Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and new homes for sale in Electronic City gated communities. KMR Real Estates serves South Bangalore’s biggest IT hub.',
    intro:
      'Electronic City is South Bangalore’s original IT township, home to Infosys, Wipro and hundreds of technology firms across Phase 1 and Phase 2. The elevated expressway and self-contained gated communities make it a top choice for families who want everything — work, schools and amenities — within a short radius. KMR Real Estates helps families settle into Electronic City’s premium 2, 3 and 4 BHK homes.',
  ...
  },
  {
    ...
    zone: 'East Bangalore (IT Corridor)',
    metaTitle:
      'Property for Rent & Sale in Bellandur, Bangalore | 2, 3 & 4 BHK Gated Flats — KMR Real Estates',
    metaDescription:
      'Find premium 2, 3 & 4 BHK flats for rent and homes for sale in Bellandur, on Bangalore’s Outer Ring Road. KMR Real Estates — local real estate experts.',
    intro:
      'Bellandur is the beating heart of the Outer Ring Road tech corridor, surrounded by Ecospace, Cessna Business Park and the offices of the world’s largest technology firms. Its high-rise gated communities are built for professionals who prize a short commute and premium amenities. KMR Real Estates helps renters and buyers secure well-appointed 2, 3 and 4 BHK homes in Bellandur.',
  ...
  },
  {
    ...
    zone: 'South Bangalore',
    metaTitle:
      'Property for Rent & Sale in HSR Layout, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and houses for sale in HSR Layout, Bangalore. KMR Real Estates — your real estate agent for South Bangalore’s startup hub.',
    intro:
      'HSR Layout is the planned, sector-based neighbourhood that has become Bangalore’s startup and design hub, prized for its wide roads, parks and cafés. It bridges Sarjapur Road, the Outer Ring Road and Koramangala, giving residents access to several tech clusters. KMR Real Estates helps professionals and families find premium 2, 3 and 4 BHK homes across HSR’s sectors.',
  ...
  },
  {
    ...
    metaTitle:
      'Property for Rent & Sale in Hebbal, Bangalore | 2, 3 & 4 BHK Gated Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and new homes for sale in Hebbal, North Bangalore. KMR Real Estates — airport-corridor real estate specialists.',
    intro:
      'Hebbal anchors North Bangalore’s growth story, with its landmark flyover linking the city to Kempegowda International Airport via the Bellary Road corridor. Lakeside gated communities and premium towers here attract executives who value airport access and Manyata Tech Park proximity. KMR Real Estates helps buyers and tenants find standout 2, 3 and 4 BHK homes in Hebbal.',
  ...
  },
  {
    ...
    zone: 'East Bangalore (IT Corridor)',
    metaTitle:
      'Property for Rent & Sale in Mahadevapura, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and homes for sale in Mahadevapura, Bangalore. KMR Real Estates — real estate agents near the Whitefield ORR belt.',
    intro:
      'Mahadevapura sits between Whitefield and the Outer Ring Road, making it one of the most commute-friendly addresses on the East Bangalore tech belt. Its gated communities range from established mid-rises to newer premium towers, serving a steady stream of IT professionals. As a Mahadevapura-headquartered firm, KMR Real Estates knows this micro-market intimately.',
    ...
    relatedBlog: ['kmr-real-estates-who-we-are', 'best-real-estate-agents-near-me-bangalore-it-corridors'],
  ...
  },
  {
    ...
    zone: 'South Bangalore',
    metaTitle:
      'Property for Rent & Sale in Koramangala, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and houses for sale in Koramangala, Bangalore. KMR Real Estates — real estate agents for the city’s startup capital.',
    intro:
      'Koramangala is Bangalore’s cosmopolitan core — a leafy, block-planned neighbourhood that doubles as the country’s startup capital. Premium apartments and boutique gated communities here command a lifestyle premium for their cafés, retail and central location. KMR Real Estates helps discerning tenants and buyers secure 2, 3 and 4 BHK homes in Koramangala.',
  ...
  },
  {
    ...
    metaTitle:
      'Property for Rent & Sale in Indiranagar, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and homes for sale in Indiranagar, Central Bangalore. KMR Real Estates — real estate agents for a prime metro-linked address.',
    intro:
      'Indiranagar is one of Bangalore’s most sought-after central neighbourhoods, blending tree-lined residential streets with the buzz of 100 Feet Road’s restaurants and boutiques. Purple Line metro access and proximity to MG Road and the CBD make it a perennial favourite. KMR Real Estates helps clients find premium 2, 3 and 4 BHK homes in Indiranagar’s prized pockets.',
  ...
  },
  {
    ...
    zone: 'South Bangalore',
    metaTitle:
      'Property for Rent & Sale in JP Nagar, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and houses for sale in JP Nagar, South Bangalore. KMR Real Estates — trusted local real estate agents.',
    intro:
      'JP Nagar is a well-established South Bangalore neighbourhood known for its orderly phases, parks and strong sense of community. It offers a calmer, family-oriented alternative to the tech corridors while staying well connected to Bannerghatta Road and the ORR. KMR Real Estates helps families find spacious 2, 3 and 4 BHK homes in JP Nagar’s gated communities.',
    rent: { bhk2: '₹24,000 – ₹38,000/mo', bhk3: '₹36,000 – ₹58,000/mo', bhk4: '₹55,000 – ₹95,000/mo' }, // VERIFY
  ...
  },
  {
    ...
    zone: 'South Bangalore',
    metaTitle:
      'Property for Rent & Sale on Bannerghatta Road, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and new homes for sale on Bannerghatta Road, Bangalore. KMR Real Estates — South Bangalore real estate specialists.',
    intro:
      'Bannerghatta Road runs south from the city through a corridor of hospitals, tech parks and IIM Bangalore, ending near the national park. Its gated communities appeal to healthcare and IT professionals who want space and greenery within reach of the core. KMR Real Estates helps buyers and tenants find well-located 2, 3 and 4 BHK homes along Bannerghatta Road.',
  ...
  },
  {
    ...
    zone: 'North Bangalore',
    metaTitle:
      'Property for Rent & Sale in Yelahanka, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and new homes for sale in Yelahanka, North Bangalore. KMR Real Estates — airport-corridor real estate agents.',
    intro:
      'Yelahanka is a spacious, planned satellite town on the northern airport corridor, prized for its wide roads, lakes and cleaner air. Premium villa communities and gated apartments here attract families and NRIs drawn to airport proximity and long-term growth. KMR Real Estates helps clients navigate Yelahanka’s expanding 2, 3 and 4 BHK inventory.',
    ...
    relatedBlog: ['new-homes-for-sale-bangalore-gated-communities-2026', 'kmr-real-estates-who-we-are'],
  ...
  },
  {
    ...
    zone: 'North Bangalore',
    metaTitle:
      'Property for Rent & Sale in Hennur, Bangalore | 2, 3 & 4 BHK Gated Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and homes for sale in Hennur, North Bangalore. KMR Real Estates — real estate agents for the airport-belt corridor.',
    intro:
      'Hennur has emerged as a fast-growing North Bangalore corridor, offering newer gated communities at attractive prices with quick links to Manyata Tech Park and the airport road. It suits professionals and young families who want modern amenities without central-city pricing. KMR Real Estates helps renters and buyers find value-rich 2, 3 and 4 BHK homes in Hennur.',
  ...
  },
  {
    ...
    zone: 'North Bangalore',
    metaTitle:
      'Property for Rent & Sale in Thanisandra, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and new homes for sale in Thanisandra, North Bangalore. KMR Real Estates — Manyata-belt real estate specialists.',
    intro:
      'Thanisandra runs alongside Manyata Tech Park, making it one of North Bangalore’s most convenient addresses for the tech workforce. A wave of new high-rise gated communities has made it a hotspot for both renters and investors. KMR Real Estates helps clients secure modern 2, 3 and 4 BHK homes in Thanisandra.',
  ...
  },
  {
    ...
    zone: 'North Bangalore',
    metaTitle:
      'Property for Rent & Sale in Devanahalli, Bangalore | 2, 3 & 4 BHK Homes — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK homes for sale and rent in Devanahalli, near Bangalore airport. KMR Real Estates — real estate agents for the northern growth corridor.',
    intro:
      'Devanahalli surrounds Kempegowda International Airport and is the epicentre of North Bangalore’s long-term growth, with the Aerospace Park, Business Park and townships driving demand. Villa communities and integrated gated developments here appeal to investors and end-users with a long horizon. KMR Real Estates helps buyers evaluate Devanahalli’s premium 2, 3 and 4 BHK options.',
  ...
  },
  {
    ...
    zone: 'South Bangalore',
    metaTitle:
      'Property for Rent & Sale in BTM Layout, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and houses for sale in BTM Layout, South Bangalore. KMR Real Estates — real estate agents near the ORR and Silk Board.',
    intro:
      'BTM Layout is one of South Bangalore’s most centrally connected residential hubs, popular with young professionals for its access to the Outer Ring Road, Koramangala and Electronic City via Silk Board. Its mix of gated apartments and independent builder floors keeps demand high year-round. KMR Real Estates helps tenants and buyers find well-connected 2, 3 and 4 BHK homes in BTM Layout.',
  ...
  },
  {
    ...
    zone: 'South Bangalore',
    metaTitle:
      'Property for Rent & Sale on Kanakapura Road, Bangalore | 2, 3 & 4 BHK Flats — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK flats for rent and new homes for sale on Kanakapura Road, Bangalore. KMR Real Estates — metro-linked South Bangalore specialists.',
    intro:
      'Kanakapura Road has transformed into a premium South Bangalore corridor thanks to the Green Line metro extension and a wave of large gated communities toward Konanakunte and Vajarahalli. Its greener, low-density character appeals to families seeking space and calm. KMR Real Estates helps buyers and tenants find spacious 2, 3 and 4 BHK homes along Kanakapura Road.',
  ...
  },
  {
    ...
    zone: 'South Bangalore',
    metaTitle:
      'Property for Rent & Sale in Jayanagar, Bangalore | 2, 3 & 4 BHK Homes — KMR Real Estates',
    metaDescription:
      'Premium 2, 3 & 4 BHK homes for rent and houses for sale in Jayanagar, South Bangalore. KMR Real Estates — real estate agents for one of the city’s best-planned areas.',
    intro:
      'Jayanagar is among Bangalore’s oldest and best-planned neighbourhoods, known for its tree-lined blocks, parks and thriving shopping district. It offers a rare mix of heritage charm, premium gated apartments and elegant independent homes, all with excellent metro access. KMR Real Estates helps clients find sought-after 2, 3 and 4 BHK homes in Jayanagar.',
