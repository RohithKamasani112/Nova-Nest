      ...
      >
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join us and find your dream home</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-blue-600 transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <button
            ...
            className="w-full px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition-all"
          >
            Sign In
          </button>
        </div>
