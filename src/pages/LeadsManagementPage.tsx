    ...
    <div className="max-w-7xl">
      <div className="mb-6 sm:mb-8">
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:gap-3">
          <div className="flex items-center justify-between gap-2 rounded-lg border border-primary/20 bg-primary-light px-3 py-2 sm:justify-start sm:px-4">
          ...
          <div className="flex items-center justify-between gap-2 rounded-lg border border-primary/20 bg-primary-light px-3 py-2 sm:justify-start sm:px-4">
            <span className="text-sm text-primary">Contacted</span>
            <span className="font-bold text-primary">{stats.contacted}</span>
          </div>
      ...
      <div className="mb-6 space-y-4">
        <input
          ...
          className="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/30 sm:py-2"
        />
            ...
            {filteredLeads.map((lead, index) => (
              ...
              >
                ...
                <select
                  ...
                  className={`mt-4 min-h-[44px] w-full rounded-lg px-3 py-2 text-sm font-medium ${statusClass(lead.status)}`}
                >
                  <option value="pending">Pending</option>
                  <option value="contacted">Contacted</option>
                  <option value="closed">Closed</option>
