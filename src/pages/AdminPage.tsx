      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <CurrencyInput field="price" label="Sale / Rent Price" required />
              <CurrencyInput field="pricePerSqft" label="Price per sqft" placeholder="Leave blank to auto-calculate" />
              <CurrencyInput field="maintenanceCharges" label="Maintenance Charges" placeholder="Monthly amount" />
              <CurrencyInput field="securityDeposit" label="Security Deposit" placeholder="Applicable for rent/lease" />
              <CurrencyInput field="bookingAmount" label="Booking Amount" placeholder="Token amount to confirm booking" />
              <div>
