...
const address = 'Ground Floor, Site No-29&30 Meshwarama Temple 1st Main Rd, Maheswari Nagar, B Narayanapura, Mahadevapura Bengaluru, Karnataka 560048';
...
const infoCards = [
  ...
  },
  {
    icon: Phone,
    title: "Let's Talk",
    content: '+91 96637 95675',
    action: { label: 'Call Now', href: 'tel:+919663795675' },
    color: '#4CAF87',
    delay: 0.1,
  },
  {
    icon: Mail,
    title: 'Email Us',
    content: 'hello@my-properties.in',
    action: { label: 'Send Email', href: 'mailto:hello@my-properties.in' },
    color: '#6B8FD4',
    delay: 0.2,
  },
  {
  ...
  return (
    <main className="bg-[#F8F6F1] text-[#1a1a1a]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="relative min-h-[420px] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0F1B2D]/80 via-[#0F1B2D]/70 to-[#0F1B2D]/90" />
        ...
        <motion.div
          ...
          className="absolute bottom-8 right-[8%] w-80 h-80 rounded-full bg-blue-400/15 blur-3xl pointer-events-none"
        />
      ...
      {/* ── STATS BAR ── */}
      <section className="bg-[#0F1B2D] py-10">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <form onSubmit={submit} className="space-y-5">
                  ...
                  <div key={key} className="relative">
                    ...
                    <div className="relative">
                      <input
                        ...
                        style={{
                          borderColor: focused === key ? '#C9A84C' : '#ebebeb',
                          boxShadow: focused === key ? '0 0 0 4px rgba(201,168,76,0.12)' : 'none',
                        }}
                      />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    style={{
                      borderColor: focused === 'message' ? '#C9A84C' : '#ebebeb',
                      boxShadow: focused === 'message' ? '0 0 0 4px rgba(201,168,76,0.12)' : 'none',
                    }}
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full py-3.5 rounded-xl bg-[#0F1B2D] text-gold text-[14px] font-bold tracking-wide flex items-center justify-center gap-2.5 hover:bg-[#1a2d4a] transition-colors"
                >
                  <Send size={16} />
                  Submit Enquiry
                </motion.button>
          ...
          >
            <iframe
              title="My-Properties office map"
              src={mapEmbedUrl}
            ...
            <div className="absolute top-4 left-4 bg-white rounded-xl px-4 py-2.5 shadow-lg flex items-center gap-2">
              ...
              <span className="text-[12px] font-bold text-[#1a1a1a]">My-Properties Office</span>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.5 }}
        className="bg-[#0F1B2D] py-16 text-center relative overflow-hidden"
      >
        <motion.div
          animate={{ rotate: 360 }}
        ...
        <div className="relative">
          ...
          <motion.a
            href="tel:+919663795675"
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-2 bg-gold text-[#0F1B2D] px-8 py-3.5 rounded-xl text-[14px] font-bold hover:brightness-105 transition-all"
          >
            <Phone size={16} />
            Call Us Now
          </motion.a>
