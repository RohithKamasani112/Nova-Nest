            ...
            <section className="rounded-2xl border border-border border-t-4 border-t-primary bg-white p-6 shadow-[0_10px_30px_rgba(15,31,61,0.08)] sm:p-8">
              ...
              <div className="mt-8 border-t border-border pt-6">
                ...
                {description.length > 220 && (
                  <button onClick={() => setExpandedDescription(!expandedDescription)} className="mt-2 inline-flex min-h-[44px] items-center font-semibold text-gold underline-offset-4 hover:underline">
